...
/**
 * This is the item provider adapter for a {@link cn.edu.pku.sei.ra.wrapping.decorate.DecModel.FeatureMap} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureMap_feature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureMap_feature_feature", "_UI_FeatureMap_type"),
				 DecModelPackage.Literals.FEATURE_MAP__FEATURE,
				 true,
				 false,
				 true,
				 null,
