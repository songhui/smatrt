...
public class GenPackageGeneratorAdapter extends GenBaseGeneratorAdapter
{
  ...
  {
    new JETEmitterDescriptor("model/PackageClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.PackageClass"),
    new JETEmitterDescriptor("model/FactoryClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.FactoryClass"),
    new JETEmitterDescriptor("model/XMLProcessorClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.XMLProcessorClass"),
    new JETEmitterDescriptor("model/ValidatorClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.ValidatorClass"),
    new JETEmitterDescriptor("model/SwitchClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.SwitchClass"),
    new JETEmitterDescriptor("model/AdapterFactoryClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.AdapterFactoryClass"),
    new JETEmitterDescriptor("model/ResourceFactoryClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.ResourceFactoryClass"),
    new JETEmitterDescriptor("model/ResourceClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.ResourceClass"),
    new JETEmitterDescriptor("edit/ItemProviderAdapterFactory.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.edit.ItemProviderAdapterFactory"),
    new JETEmitterDescriptor("editor/Editor.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.Editor"),
    new JETEmitterDescriptor("editor/ModelWizard.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.ModelWizard"),
    new JETEmitterDescriptor("editor/ActionBarContributor.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.ActionBarContributor"),
    new JETEmitterDescriptor("model.tests/PackageTestSuite.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.tests.PackageTestSuite"),
    new JETEmitterDescriptor("model.tests/PackageExample.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.tests.PackageExample")
  };
  ...
  protected Diagnostic generateModel(Object object, Monitor monitor)
  {
    ...
    message = CodeGenEcorePlugin.INSTANCE.getString
      ("_UI_GeneratingPackage_message", new Object[] { genPackage.getPackageName() });
  ...
  protected Diagnostic generateEdit(Object object, Monitor monitor)
  {
    ...
    message = CodeGenEcorePlugin.INSTANCE.getString
      ("_UI_GeneratingItemProvidersForPackage_message", new Object[] { genPackage.getPackageName() });
    monitor.subTask(message);
  ...
  protected Diagnostic generateEditor(Object object, Monitor monitor)
  {
    ...
    GenPackage genPackage = (GenPackage)object;
    message = CodeGenEcorePlugin.INSTANCE.getString
      ("_UI_GeneratingEditorForPackage_message", new Object[] { genPackage.getPackageName() });
    monitor.subTask(message);
  ...
  protected Diagnostic generateTests(Object object, Monitor monitor)
  {
    ...
    GenPackage genPackage = (GenPackage)object;
    message = CodeGenEcorePlugin.INSTANCE.getString
      ("_UI_GeneratingTestsForPackage_message", new Object[] { genPackage.getPackageName() });
    monitor.subTask(message);
