...
public class GenClassGeneratorAdapter extends GenBaseGeneratorAdapter
{
  ...
  {
    new JETEmitterDescriptor("model/Class.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.Class"),
    new JETEmitterDescriptor("edit/ItemProvider.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.edit.ItemProvider"),
    new JETEmitterDescriptor("model.tests/TestCase.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.tests.TestCase")
  };
