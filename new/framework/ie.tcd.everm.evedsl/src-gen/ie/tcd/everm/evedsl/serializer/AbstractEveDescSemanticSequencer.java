package ie.tcd.everm.evedsl.serializer;
...
public class AbstractEveDescSemanticSequencer extends AbstractSemanticSequencer {

	@Inject
	protected EveDescGrammarAccess grammarAccess;
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == EveDescPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case EveDescPackage.CONSTANT_TEXT:
				if(context == grammarAccess.getAbstractTextValueRule() ||
				   context == grammarAccess.getConstantTextRule()) {
					sequence_ConstantText(context, (ConstantText) semanticObject); 
					return; 
				}
				else break;
			...
			case EveDescPackage.EVENT_DESC:
				if(context == grammarAccess.getEventDescRule()) {
					sequence_EventDesc(context, (EventDesc) semanticObject); 
					return; 
				}
				else break;
			case EveDescPackage.EVENT_SEQ:
				if(context == grammarAccess.getEventSeqRule()) {
					sequence_EventSeq(context, (EventSeq) semanticObject); 
					return; 
				}
				else break;
			case EveDescPackage.HELPER:
				if(context == grammarAccess.getHelperRule()) {
			...
			case EveDescPackage.IGNORE_VALUE:
				if(context == grammarAccess.getAbstractTextValueRule() ||
				   context == grammarAccess.getIgnoreValueRule()) {
			...
			case EveDescPackage.INVOCATION:
				if(context == grammarAccess.getInvocationRule()) {
			...
			case EveDescPackage.OPERATION_POINT_CUT:
				if(context == grammarAccess.getOperationPointCutRule()) {
					sequence_OperationPointCut(context, (OperationPointCut) semanticObject); 
					return; 
				}
				else break;
			case EveDescPackage.PLAIN_PARSER:
				if(context == grammarAccess.getParserRule() ||
				   context == grammarAccess.getPlainParserRule()) {
					sequence_PlainParser(context, (PlainParser) semanticObject); 
					return; 
				}
				else break;
			...
			case EveDescPackage.SPLIT_FORMATTER:
				if(context == grammarAccess.getSplitFormatterRule() ||
				   context == grammarAccess.getTextFormatterRule()) {
					sequence_SplitFormatter(context, (SplitFormatter) semanticObject); 
					return; 
				}
				else break;
			...
			case EveDescPackage.TEXT_PARSER:
				if(context == grammarAccess.getParserRule() ||
				   context == grammarAccess.getTextParserRule()) {
					sequence_TextParser(context, (TextParser) semanticObject); 
					return; 
				}
				else break;
			case EveDescPackage.USER_DEFINED_FORMATTER:
				if(context == grammarAccess.getTextFormatterRule() ||
				   context == grammarAccess.getUserDefinedFormatterRule()) {
					sequence_UserDefinedFormatter(context, (UserDefinedFormatter) semanticObject); 
					return; 
				}
				else break;
			...
			case XbasePackage.XVARIABLE_DECLARATION:
				if(context == grammarAccess.getVarValueVariableDescRule()) {
					sequence_VarValueVariableDesc(context, (XVariableDeclaration) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getVariableDecRule()) {
					sequence_VariableDec(context, (XVariableDeclaration) semanticObject); 
					return; 
				}
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName helper+=Helper* mapping+=Mapping* invocation+=Invocation*)
	 */
	 ...
	 *     content=STRING
	 */
	protected void sequence_ConstantText(EObject context, ConstantText semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EveDescPackage.Literals.CONSTANT_TEXT__CONTENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EveDescPackage.Literals.CONSTANT_TEXT__CONTENT));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getConstantTextAccess().getContentSTRINGTerminalRuleCall_0(), semanticObject.getContent());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName imports+=Import* sequence+=EventSeq* api+=API*)
	 */
	protected void sequence_EventDesc(EObject context, EventDesc semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName helper+=Helper* event+=Event*)
	 */
	protected void sequence_EventSeq(EObject context, EventSeq semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (name=ID decScope+=DecScope* parser=Parser pre+=XExpression* post=XBlockExpression)
	 */
	...
	/**
	 * Constraint:
	 *     (name=ID (params+=FullJvmFormalParameter params+=FullJvmFormalParameter*)? type=JvmTypeReference body=XBlockExpression)
	 */
	 ...
	 *     ignore?='Ignore'
	 */
	protected void sequence_IgnoreValue(EObject context, IgnoreValue semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EveDescPackage.Literals.IGNORE_VALUE__IGNORE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EveDescPackage.Literals.IGNORE_VALUE__IGNORE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getIgnoreValueAccess().getIgnoreIgnoreKeyword_0(), semanticObject.isIgnore());
		feeder.finish();
	}
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EveDescPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EveDescPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	 ...
	 *     )
	 */
	protected void sequence_Invocation(EObject context, Invocation semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (opType=OperationType elemType=JvmTypeReference? feature=ID? pre=XBlockExpression)
	 */
	protected void sequence_OperationPointCut(EObject context, OperationPointCut semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (ivar+=XVariableDeclaration* logic=XBlockExpression)
	 */
	protected void sequence_PlainParser(EObject context, PlainParser semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     spliter=STRING
	 */
	protected void sequence_SplitFormatter(EObject context, SplitFormatter semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EveDescPackage.Literals.SPLIT_FORMATTER__SPLITER) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EveDescPackage.Literals.SPLIT_FORMATTER__SPLITER));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getSplitFormatterAccess().getSpliterSTRINGTerminalRuleCall_2_0(), semanticObject.getSpliter());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (type=JvmTypeReference pre=XBlockExpression)
	 */
	protected void sequence_SubType(EObject context, SubType semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EveDescPackage.Literals.SUB_TYPE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EveDescPackage.Literals.SUB_TYPE__TYPE));
			if(transientValues.isValueTransient(semanticObject, EveDescPackage.Literals.SUB_TYPE__PRE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EveDescPackage.Literals.SUB_TYPE__PRE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getSubTypeAccess().getTypeJvmTypeReferenceParserRuleCall_1_0(), semanticObject.getType());
		feeder.accept(grammarAccess.getSubTypeAccess().getPreXBlockExpressionParserRuleCall_2_0(), semanticObject.getPre());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (formatter=TextFormatter? ivar+=XVariableDeclaration? value+=AbstractTextValue*)
	 */
	protected void sequence_TextParser(EObject context, TextParser semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     expr=XExpression
	 */
	protected void sequence_UserDefinedFormatter(EObject context, UserDefinedFormatter semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EveDescPackage.Literals.USER_DEFINED_FORMATTER__EXPR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EveDescPackage.Literals.USER_DEFINED_FORMATTER__EXPR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getUserDefinedFormatterAccess().getExprXExpressionParserRuleCall_2_0(), semanticObject.getExpr());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_VarValueVariableDesc(EObject context, XVariableDeclaration semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_VarValue(EObject context, VarValue semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EveDescPackage.Literals.VAR_VALUE__VARIABLE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EveDescPackage.Literals.VAR_VALUE__VARIABLE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getVarValueAccess().getVariableVarValueVariableDescParserRuleCall_1_0(), semanticObject.getVariable());
		feeder.finish();
	}
