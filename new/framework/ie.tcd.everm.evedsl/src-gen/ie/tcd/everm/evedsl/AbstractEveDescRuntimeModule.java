...
/**
 * Manual modifications go to {ie.tcd.everm.evedsl.EveDescRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractEveDescRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "ie/tcd/everm/evedsl/EveDesc.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("ie.tcd.everm.evedsl.EveDesc");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("evedsl");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return ie.tcd.everm.evedsl.services.EveDescGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return ie.tcd.everm.evedsl.serializer.AbstractEveDescSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return ie.tcd.everm.evedsl.serializer.AbstractEveDescSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return ie.tcd.everm.evedsl.parser.antlr.EveDescParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return ie.tcd.everm.evedsl.parser.antlr.EveDescAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return ie.tcd.everm.evedsl.parser.antlr.internal.InternalEveDescLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<ie.tcd.everm.evedsl.parser.antlr.internal.InternalEveDescLexer> provideInternalEveDescLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(ie.tcd.everm.evedsl.parser.antlr.internal.InternalEveDescLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(ie.tcd.everm.evedsl.parser.antlr.internal.InternalEveDescLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends ie.tcd.everm.evedsl.validation.EveDescJavaValidator> bindEveDescJavaValidator() {
		return ie.tcd.everm.evedsl.validation.EveDescJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return ie.tcd.everm.evedsl.formatting.EveDescFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return ie.tcd.everm.evedsl.jvmmodel.EveDescJvmModelInferrer.class;
	}
