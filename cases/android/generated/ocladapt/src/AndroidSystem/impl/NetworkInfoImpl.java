 ...
 * <ul>
 *   <li>{@link AndroidSystem.impl.NetworkInfoImpl#getTypeName <em>Type Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NetworkInfoImpl extends WrappingEObjectImpl implements NetworkInfo
{
  /**
  ...
  {
    return AndroidSystemPackage.Literals.NETWORK_INFO;
  }
   ...
   */ 
   public boolean isForCore(Object arg0){
    ...
    try{
    result=((android.net.NetworkInfo)core).getType()==((android.net.NetworkInfo)arg0).getType();
    }
    catch(Exception e){
      result=false;
    }
  ...
  public List listSubCores(int featureID){
    ...
    android.net.NetworkInfo core=(android.net.NetworkInfo)this.getCore();
    if(core==null) 
      return result;
    switch(featureID){
  ...
  {
        Object result=null;
        android.net.NetworkInfo core=(android.net.NetworkInfo)getCore();
        if(core==null) return typeName;	
        typeName=core.getTypeName();
    return typeName; 
  }
  ...
  public void setTypeName(String newTypeName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AndroidSystemPackage.NETWORK_INFO__TYPE_NAME, oldTypeName, typeName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AndroidSystemPackage.NETWORK_INFO__TYPE_NAME:
        return getTypeName();
    }
