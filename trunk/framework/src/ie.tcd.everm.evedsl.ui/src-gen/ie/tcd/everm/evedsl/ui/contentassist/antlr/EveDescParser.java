...
* generated by Xtext
*/
package ie.tcd.everm.evedsl.ui.contentassist.antlr;
...
public class EveDescParser extends AbstractContentAssistParser {
	...
	@Override
	protected ie.tcd.everm.evedsl.ui.contentassist.antlr.internal.InternalEveDescParser createParser() {
		ie.tcd.everm.evedsl.ui.contentassist.antlr.internal.InternalEveDescParser result = new ie.tcd.everm.evedsl.ui.contentassist.antlr.internal.InternalEveDescParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getParserAccess().getAlternatives(), "rule__Parser__Alternatives");
					put(grammarAccess.getTextFormatterAccess().getAlternatives(), "rule__TextFormatter__Alternatives");
					put(grammarAccess.getAbstractTextValueAccess().getAlternatives(), "rule__AbstractTextValue__Alternatives");
					put(grammarAccess.getOperationPointCutAccess().getAlternatives_2(), "rule__OperationPointCut__Alternatives_2");
					put(grammarAccess.getOperationPointCutAccess().getAlternatives_4(), "rule__OperationPointCut__Alternatives_4");
					...
					put(grammarAccess.getEventDescAccess().getGroup(), "rule__EventDesc__Group__0");
					...
					put(grammarAccess.getHelperAccess().getGroup_3_1(), "rule__Helper__Group_3_1__0");
					put(grammarAccess.getEventSeqAccess().getGroup(), "rule__EventSeq__Group__0");
					put(grammarAccess.getEventAccess().getGroup(), "rule__Event__Group__0");
					put(grammarAccess.getTextParserAccess().getGroup(), "rule__TextParser__Group__0");
					put(grammarAccess.getTextParserAccess().getGroup_1(), "rule__TextParser__Group_1__0");
					put(grammarAccess.getTextParserAccess().getGroup_3(), "rule__TextParser__Group_3__0");
					put(grammarAccess.getSplitFormatterAccess().getGroup(), "rule__SplitFormatter__Group__0");
					put(grammarAccess.getUserDefinedFormatterAccess().getGroup(), "rule__UserDefinedFormatter__Group__0");
					put(grammarAccess.getVarValueAccess().getGroup(), "rule__VarValue__Group__0");
					...
					put(grammarAccess.getInvocationAccess().getGroup_8(), "rule__Invocation__Group_8__0");
					put(grammarAccess.getInvocationAccess().getGroup_11(), "rule__Invocation__Group_11__0");
					put(grammarAccess.getOperationPointCutAccess().getGroup(), "rule__OperationPointCut__Group__0");
					...
					put(grammarAccess.getEventDescAccess().getNameAssignment_1(), "rule__EventDesc__NameAssignment_1");
					put(grammarAccess.getEventDescAccess().getImportsAssignment_2(), "rule__EventDesc__ImportsAssignment_2");
					put(grammarAccess.getEventDescAccess().getSequenceAssignment_3(), "rule__EventDesc__SequenceAssignment_3");
					put(grammarAccess.getEventDescAccess().getApiAssignment_4(), "rule__EventDesc__ApiAssignment_4");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getHelperAccess().getNameAssignment_1(), "rule__Helper__NameAssignment_1");
					put(grammarAccess.getHelperAccess().getParamsAssignment_3_0(), "rule__Helper__ParamsAssignment_3_0");
					put(grammarAccess.getHelperAccess().getParamsAssignment_3_1_1(), "rule__Helper__ParamsAssignment_3_1_1");
					put(grammarAccess.getHelperAccess().getTypeAssignment_6(), "rule__Helper__TypeAssignment_6");
					put(grammarAccess.getHelperAccess().getBodyAssignment_7(), "rule__Helper__BodyAssignment_7");
					put(grammarAccess.getEventSeqAccess().getNameAssignment_1(), "rule__EventSeq__NameAssignment_1");
					put(grammarAccess.getEventSeqAccess().getHelperAssignment_3(), "rule__EventSeq__HelperAssignment_3");
					put(grammarAccess.getEventSeqAccess().getEventAssignment_4(), "rule__EventSeq__EventAssignment_4");
					put(grammarAccess.getEventAccess().getNameAssignment_1(), "rule__Event__NameAssignment_1");
					put(grammarAccess.getEventAccess().getDecScopeAssignment_3(), "rule__Event__DecScopeAssignment_3");
					put(grammarAccess.getEventAccess().getParserAssignment_5(), "rule__Event__ParserAssignment_5");
					put(grammarAccess.getEventAccess().getPreAssignment_8(), "rule__Event__PreAssignment_8");
					put(grammarAccess.getEventAccess().getPostAssignment_11(), "rule__Event__PostAssignment_11");
					...
					put(grammarAccess.getVarValueVariableDescAccess().getNameAssignment_0(), "rule__VarValueVariableDesc__NameAssignment_0");
					put(grammarAccess.getVarValueVariableDescAccess().getWriteableAssignment_1(), "rule__VarValueVariableDesc__WriteableAssignment_1");
					put(grammarAccess.getVarValueVariableDescAccess().getTypeAssignment_2(), "rule__VarValueVariableDesc__TypeAssignment_2");
					put(grammarAccess.getConstantTextAccess().getContentAssignment(), "rule__ConstantText__ContentAssignment");
					...
					put(grammarAccess.getVariableDecAccess().getWriteableAssignment_2(), "rule__VariableDec__WriteableAssignment_2");
					...
					put(grammarAccess.getAPIAccess().getInvocationAssignment_5(), "rule__API__InvocationAssignment_5");
					put(grammarAccess.getMappingAccess().getMTypeAssignment_1(), "rule__Mapping__MTypeAssignment_1");
					put(grammarAccess.getMappingAccess().getSTypeAssignment_3(), "rule__Mapping__STypeAssignment_3");
					put(grammarAccess.getMappingAccess().getUniqueAssignment_4(), "rule__Mapping__UniqueAssignment_4");
					put(grammarAccess.getMappingAccess().getIdentifyAssignment_6_1(), "rule__Mapping__IdentifyAssignment_6_1");
					put(grammarAccess.getMappingAccess().getSubTypeAssignment_7(), "rule__Mapping__SubTypeAssignment_7");
					put(grammarAccess.getMappingAccess().getNewImageAssignment_9(), "rule__Mapping__NewImageAssignment_9");
					put(grammarAccess.getSubTypeAccess().getTypeAssignment_1(), "rule__SubType__TypeAssignment_1");
					put(grammarAccess.getSubTypeAccess().getPreAssignment_2(), "rule__SubType__PreAssignment_2");
					put(grammarAccess.getInvocationAccess().getNameAssignment_1(), "rule__Invocation__NameAssignment_1");
					put(grammarAccess.getInvocationAccess().getVariableAssignment_3(), "rule__Invocation__VariableAssignment_3");
					put(grammarAccess.getInvocationAccess().getOperationAssignment_4(), "rule__Invocation__OperationAssignment_4");
					put(grammarAccess.getInvocationAccess().getPreAssignment_6(), "rule__Invocation__PreAssignment_6");
					put(grammarAccess.getInvocationAccess().getRetTypeAssignment_8_1(), "rule__Invocation__RetTypeAssignment_8_1");
					put(grammarAccess.getInvocationAccess().getInvokeAssignment_9(), "rule__Invocation__InvokeAssignment_9");
					put(grammarAccess.getInvocationAccess().getPostparaAssignment_11_1(), "rule__Invocation__PostparaAssignment_11_1");
					put(grammarAccess.getInvocationAccess().getPostAssignment_12(), "rule__Invocation__PostAssignment_12");
					put(grammarAccess.getOperationPointCutAccess().getOpTypeAssignment_1(), "rule__OperationPointCut__OpTypeAssignment_1");
					put(grammarAccess.getOperationPointCutAccess().getElemTypeAssignment_2_0(), "rule__OperationPointCut__ElemTypeAssignment_2_0");
					put(grammarAccess.getOperationPointCutAccess().getFeatureAssignment_4_0(), "rule__OperationPointCut__FeatureAssignment_4_0");
					put(grammarAccess.getOperationPointCutAccess().getPreAssignment_5(), "rule__OperationPointCut__PreAssignment_5");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			ie.tcd.everm.evedsl.ui.contentassist.antlr.internal.InternalEveDescParser typedParser = (ie.tcd.everm.evedsl.ui.contentassist.antlr.internal.InternalEveDescParser) parser;
			typedParser.entryRuleEventDesc();
