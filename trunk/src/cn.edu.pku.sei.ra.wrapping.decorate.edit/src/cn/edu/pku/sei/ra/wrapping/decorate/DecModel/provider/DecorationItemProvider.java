...
/**
 * This is the item provider adapter for a {@link cn.edu.pku.sei.ra.wrapping.decorate.DecModel.Decoration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DecorationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DecModelPackage.Literals.DECORATION__IMPORT_CLASS);
			childrenFeatures.add(DecModelPackage.Literals.DECORATION__CODE_AREA);
			childrenFeatures.add(DecModelPackage.Literals.DECORATION__MAP_AREA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DecModelPackage.Literals.DECORATION__IMPORT_CLASS,
				 DecModelFactory.eINSTANCE.createImportClass()));

		newChildDescriptors.add
			(createChildParameter
				(DecModelPackage.Literals.DECORATION__CODE_AREA,
				 DecModelFactory.eINSTANCE.createCodeArea()));

		newChildDescriptors.add
			(createChildParameter
				(DecModelPackage.Literals.DECORATION__MAP_AREA,
				 DecModelFactory.eINSTANCE.createMapArea()));
	}
