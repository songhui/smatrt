 ...
 */
package cn.edu.pku.sei.ra.wrapping.codegen.genmodel.generator;
...
import cn.edu.pku.sei.ra.wrapping.codegen.CodeGenEcorePlugin;
import cn.edu.pku.sei.ra.wrapping.codegen.generator.GeneratorAdapter;
import cn.edu.pku.sei.ra.wrapping.codegen.generator.GeneratorAdapterFactory;
 ...
 * <code>cn.edu.pku.sei.ra.wrapping.codegen.generatorAdapters</code> extension point.
 * 
...
public class GenModelGeneratorAdapter extends GenBaseGeneratorAdapter
{
  ...
  {
    new JETEmitterDescriptor("model/Plugin.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.Plugin"),
    new JETEmitterDescriptor("model/manifest.mfjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.ManifestMF"),
    new JETEmitterDescriptor("model/plugin.xmljet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.PluginXML"),
    new JETEmitterDescriptor("model/plugin.propertiesjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.PluginProperties"),
    new JETEmitterDescriptor("model/build.propertiesjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.BuildProperties"),
    new JETEmitterDescriptor("edit/Plugin.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.edit.Plugin"),
    new JETEmitterDescriptor("edit/manifest.mfjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.edit.ManifestMF"),
    new JETEmitterDescriptor("edit/plugin.xmljet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.edit.PluginXML"),
    new JETEmitterDescriptor("edit/plugin.propertiesjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.edit.PluginProperties"),
    new JETEmitterDescriptor("edit/build.propertiesjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.edit.BuildProperties"),
    new JETEmitterDescriptor("editor/Plugin.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.Plugin"),
    new JETEmitterDescriptor("editor/manifest.mfjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.ManifestMF"),
    new JETEmitterDescriptor("editor/plugin.xmljet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.PluginXML"),
    new JETEmitterDescriptor("editor/plugin.propertiesjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.PluginProperties"),
    new JETEmitterDescriptor("editor/build.propertiesjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.BuildProperties"),
    new JETEmitterDescriptor("editor/Advisor.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.editor.Advisor"),
    new JETEmitterDescriptor("model.tests/ModelTestSuite.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.tests.ModelTestSuite"),
    new JETEmitterDescriptor("model.tests/manifest.mfjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.tests.ManifestMF"),
    new JETEmitterDescriptor("model.tests/plugin.xmljet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.tests.PluginXML"),
    new JETEmitterDescriptor("model.tests/plugin.propertiesjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.tests.PluginProperties"),
    new JETEmitterDescriptor("model.tests/build.propertiesjet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.tests.BuildProperties")
  };
