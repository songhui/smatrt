...
public class GenEnumGeneratorAdapter extends GenBaseGeneratorAdapter
{
  ...
  {
    new JETEmitterDescriptor("model/EnumClass.javajet", "cn.edu.pku.sei.ra.wrapping.codegen.templates.model.EnumClass")
  };
  ...
  /**
   * Returns the {@link cn.edu.pku.sei.ra.wrapping.codegen.genmodel.GenPackage} that contains the given {@link GenEnum}.
   */
  @Override
