...
/**
 * A generator adapter factory for the {@link cn.edu.pku.sei.ra.wrapping.codegen.genmodel.GenModelPackage GenModel package}.
...
public class GenModelGeneratorAdapterFactory extends GenModelAdapterFactory implements GeneratorAdapterFactory
{
   ...
   * {@link cn.edu.pku.sei.ra.wrapping.codegen.generator.GeneratorAdapterFactory.Descriptor.Registry#addDescriptor(String, cn.edu.pku.sei.ra.wrapping.codegen.generator.GeneratorAdapterFactory.Descriptor) register}
   * it.
   * @see cn.edu.pku.sei.ra.wrapping.codegen.generator.GeneratorAdapterFactory.Descriptor.Registry
   */
   ...
   * in setting the generator's {@link cn.edu.pku.sei.ra.wrapping.codegen.generator.Generator.Options#templatePath templatePath}
   ...
   * {@link cn.edu.pku.sei.ra.wrapping.codegen.generator.AbstractGeneratorAdapter#addBaseTemplatePathEntries(java.util.List)}.
   * 
   ...
   * {@link cn.edu.pku.sei.ra.wrapping.codegen.generator.Generator.Options#mergeRulesURI mergeRulesURI} option. Now, if this
   * method is not overridden, the new {@link #getMergeRulesURI(GenModel)} method will be invoked to compute that value. 
   * 
   * @deprecated cn.edu.pku.sei.ra.wrapping.codegen 2.2.2 Override
   *              {@link cn.edu.pku.sei.ra.wrapping.codegen.generator.AbstractGeneratorAdapter#addBaseTemplatePathEntries(java.util.List)}
   ...
   * 
   * @since cn.edu.pku.sei.ra.wrapping.codegen 2.2.2
   */
